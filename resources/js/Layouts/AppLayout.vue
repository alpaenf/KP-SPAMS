                    ...
                    <div class="flex items-center">
                        ...
                        <div v-if="$page.props.auth?.user" class="hidden md:ml-10 md:flex md:space-x-8">
                            ...
                            <Link 
                                ...
                                :class="{
                                    'inline-flex items-center px-1 pt-1 text-sm font-medium border-b-2 transition-colors': true,
                                    'border-blue-600 text-blue-700 font-semibold': isActive('/riwayat-pembayaran'),
                                    'border-transparent text-gray-700 hover:text-blue-800 hover:border-gray-300': !isActive('/riwayat-pembayaran')
                                }"
                            >
                                Riwayat Pembayaran
                            </Link>
                ...
                <div v-if="$page.props.auth?.user && mobileMenuOpen" class="fixed top-0 right-0 bottom-0 w-80 max-w-full bg-white shadow-xl z-[80] md:hidden overflow-y-auto">
                    ...
                    <div class="p-4 pb-8">
                        <div class="flex flex-col space-y-2">
                            ...
                            <Link href="/riwayat-pembayaran" @click="mobileMenuOpen = false" :class="{
                                'flex items-center px-4 py-3 text-base font-medium rounded-lg transition': true,
                                'bg-blue-50 text-blue-800': isActive('/riwayat-pembayaran'),
                                'text-gray-700 hover:bg-gray-50': !isActive('/riwayat-pembayaran')
                            }">
                                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
