            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-6 sm:mb-8">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4">
                        <Link
                            href="/qr-scanner"
                            class="group bg-gradient-to-br from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white rounded-xl shadow-lg hover:shadow-xl hover:-translate-y-1 active:scale-95 transition-all duration-200 p-4 sm:p-6 touch-manipulation"
                        >
                        ...
                        <Link
                            href="/cek-pelanggan"
                            class="group bg-gradient-to-br from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white rounded-xl shadow-lg hover:shadow-xl hover:-translate-y-1 active:scale-95 transition-all duration-200 p-4 sm:p-6 touch-manipulation"
                        >
                            <div class="flex items-center justify-between">
                                <div>
                        ...
                        <Link
                            href="/laporan"
                            class="group bg-gradient-to-br from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white rounded-xl shadow-lg hover:shadow-xl hover:-translate-y-1 active:scale-95 transition-all duration-200 p-4 sm:p-6 touch-manipulation"
                        >
                            <div class="flex items-center justify-between">
                                <div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6 mb-8">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <Link href="/laporan" class="text-sm text-blue-700 font-medium hover:text-blue-800 inline-block active:scale-95 transition-transform">Lihat Semua Laporan →</Link>
                    </div>
                        ...
                        <div class="space-y-3 max-h-80 overflow-y-auto">
                            <div v-for="p in pelangganBelumBayar" :key="p.id" class="flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                                ...
                                <div class="flex gap-2">
                                    <a v-if="p.no_whatsapp" :href="waLink(p.no_whatsapp)" target="_blank" class="p-2 bg-blue-100 text-blue-800 rounded-lg hover:bg-blue-200 active:scale-90 transition-all duration-200" title="Chat WhatsApp">
                                    ...
                                    <Link :href="`/pelanggan/${p.id}/edit`" class="p-2 bg-blue-100 text-blue-800 rounded-lg hover:bg-blue-200 active:scale-90 transition-all duration-200" title="Edit">
                            ...
                            <div v-if="pembayaran.belumBayarCount > 10" class="text-center pt-3 border-t">
                                <Link href="/cek-pelanggan" class="text-blue-800 hover:text-blue-900 font-semibold text-sm inline-block active:scale-95 transition-transform">
                ...
                <div class="bg-white rounded-lg shadow-md p-6 mb-8">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <button 
                            ...
                            class="px-4 py-2 bg-blue-800 text-white rounded-lg hover:bg-blue-900 active:scale-95 transition-all duration-200 flex items-center gap-2"
                        >
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                            </svg>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-5 border border-blue-200">
                            <div class="flex items-center justify-between mb-2">
                                <h4 class="text-sm font-medium text-blue-900">Pendapatan Kotor Air (Tanpa Abonemen)</h4>
                            ...
                            <p class="text-xs text-blue-700 mt-1">Dasar perhitungan 20% penarik</p>
                        </div>

                        <!-- Total Abonemen -->
                        <div class="bg-gradient-to-br from-cyan-50 to-cyan-100 rounded-lg p-5 border border-cyan-200">
                            <div class="flex items-center justify-between mb-2">
                                <h4 class="text-sm font-medium text-cyan-900">Total Abonemen</h4>
                            ...
                            <p class="text-xs text-cyan-700 mt-1">Berdiri Sendiri / Terpisah</p>
                        </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <Link 
                            href="/cek-pelanggan"
                            class="flex items-center p-4 bg-blue-50 hover:bg-blue-100 rounded-lg hover:shadow-md hover:-translate-y-0.5 active:scale-95 transition-all duration-200"
                        >
                        ...
                        <Link 
                            href="/"
                            class="flex items-center p-4 bg-purple-50 hover:bg-purple-100 rounded-lg hover:shadow-md hover:-translate-y-0.5 active:scale-95 transition-all duration-200"
                        >
                    ...
                    <form @submit.prevent="submitOperasional">
                        ...
                        <div class="flex gap-3">
                            <button 
                                type="submit"
                                :disabled="processing"
                                class="flex-1 px-4 py-2 bg-blue-800 text-white rounded-lg hover:bg-blue-900 active:scale-95 transition-all duration-200 disabled:opacity-50"
                            >
                            ...
                            <button 
                                ...
                                class="px-4 py-2 bg-gray-300 text-gray-700 rounded-lg hover:bg-gray-400 active:scale-95 transition-all duration-200"
                            >
                                Batal
                            </button>
                        </div>
