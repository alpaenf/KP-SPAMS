  ...
  <AppLayout>
    <div class="max-w-4xl mx-auto px-4 py-8">
      <div class="mb-8">
        ...
        <h1 class="text-4xl font-bold text-gray-900">Edit Layanan</h1>
        <p class="text-gray-600 mt-2">Ubah informasi layanan KP-SPAMS</p>
      </div>
...
const form = useForm({
  judul: props.layanan.judul,
  deskripsi: props.layanan.deskripsi,
  icon: props.layanan.icon || '',
  foto: null,
});

const submitForm = () => {
  form.put(route('layanan.update', props.layanan.id));
};
</script>
