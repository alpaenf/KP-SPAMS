                    ...
                    <div v-if="!scannedData && !cameraStarted" class="text-center space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <button
                                ...
                                class="p-6 border-2 border-blue-500 rounded-lg hover:bg-blue-50 hover:shadow-lg hover:-translate-y-1 active:scale-95 active:shadow-md transition-all duration-200 group"
                            >
                                <svg class="w-16 h-16 mx-auto mb-3 text-blue-600 group-hover:text-blue-700 group-hover:scale-110 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" />
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 13a3 3 0 11-6 0 3 3 0 016 0z" />
                                </svg>
                                <div class="font-semibold text-gray-800 group-hover:text-blue-600 transition-colors">Scan Live</div>
                            ...
                            <button
                                ...
                                class="p-6 border-2 border-green-500 rounded-lg hover:bg-green-50 hover:shadow-lg hover:-translate-y-1 active:scale-95 active:shadow-md transition-all duration-200 group"
                            >
                                <svg class="w-16 h-16 mx-auto mb-3 text-green-600 group-hover:text-green-700 group-hover:scale-110 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                </svg>
                                <div class="font-semibold text-gray-800 group-hover:text-green-600 transition-colors">Upload Foto</div>
                            ...
                            <button
                                ...
                                class="p-6 border-2 border-yellow-500 rounded-lg hover:bg-yellow-50 hover:shadow-lg hover:-translate-y-1 active:scale-95 active:shadow-md transition-all duration-200 group"
                            >
                                <svg class="w-16 h-16 mx-auto mb-3 text-yellow-600 group-hover:text-yellow-700 group-hover:scale-110 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                </svg>
                                <div class="font-semibold text-gray-800 group-hover:text-yellow-600 transition-colors">Input Manual</div>
