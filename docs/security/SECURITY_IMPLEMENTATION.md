...
1. **[docs/security/SECURITY_AUDIT_REPORT.md](../security/SECURITY_AUDIT_REPORT.md)**  
   Laporan audit keamanan lengkap dengan skor dan rekomendasi

2. **[docs/deploy/PRODUCTION_DEPLOYMENT.md](../deploy/PRODUCTION_DEPLOYMENT.md)**  
   Panduan deployment ke production server

3. **[docs/security/KEAMANAN_QR_CODE.md](../security/KEAMANAN_QR_CODE.md)** *(existing)*  
   Dokumentasi keamanan QR scanner

4. **[docs/fixes/SOLUSI_CSRF_MISMATCH.md](../fixes/SOLUSI_CSRF_MISMATCH.md)** *(existing)*  
...
ls -la docs/security/SECURITY_AUDIT_REPORT.md
ls -la docs/deploy/PRODUCTION_DEPLOYMENT.md
