...
- [docs/security/QR_SECURITY_ROLE_PENARIK.md](../security/QR_SECURITY_ROLE_PENARIK.md) - Keamanan QR code
- [docs/implementation/IMPLEMENTASI_ROLE_PENARIK.md](../implementation/IMPLEMENTASI_ROLE_PENARIK.md) - Technical docs
- [docs/how-to/CHECK_PENARIK_LOGIN.md](../how-to/CHECK_PENARIK_LOGIN.md) - Debug login issues
